package spg.lgdev.uhc.util.json;
...
public abstract class TextualComponent implements Cloneable {
    ...
    /**
     * Create a textual component representing a top.potl.practice.scoreboard value.
     ...
     * @return The text component representing the specified top.potl.practice.scoreboard score (for the viewing player), or {@code null} if an error occurs during JSON serialization.
     */
     ...
     * @param scoreboardObjective The name of the objective for which to display the score.
     * @return The text component representing the specified top.potl.practice.scoreboard score for the specified player, or {@code null} if an error occurs during JSON serialization.
     */
    ...
    private static class ComplexTextTypeComponent extends TextualComponent implements ConfigurationSerializable {
        ...
        public Map<String, Object> serialize() {
            return new HashMap<String, Object>() {{
                put("key", getKey());
                for (final Entry<String, String> valEntry : getValue().entrySet()) {
